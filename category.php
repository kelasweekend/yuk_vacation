...
<body class='oGrd bD onId onHm' id='mainCont'>
    ...
    <div class='mainWrp'>
        ...
        <div class='secIn section' id='notif-widget'>
            <div class='widget HTML' data-version='2' id='HTML0'>
                ...
                <div class='ntfC'>
                    <div class='ntfT'>
                        <div class='ntfA'>
                            <span>
                                Filter dengan Category : <?php echo $data_kat['name']; ?>
                            </span>
                        </div>
                    </div>
                                ...
                                <div class="section" id="main-widget">
                                    <div class="widget Blog" data-version="2" id="Blog1">
                                        <div class="blogTtl hm">
                                            <h3 class="title">Wisata dengan category</h3>
                                        </div>
                                        <div class="blogPts">
                                            <!-- perulangan data yang di DB WISATA -->
                                            <?php

                                            $id = $data_kat['id'];
                                            // panggil semua data wisata menggunakan query select wisata
                                            $query = "SELECT * FROM wisata WHERE category_id=$id ORDER BY id ASC";
                                            $result = mysqli_query($koneksi, $query);
                                            // cek apakah ada error saat menjalankan query
                                            if (!$result) {
                                                die("query salah" . mysqli_errno($koneksi) . "-" . mysqli_error($koneksi));
                                            ...
                                            ?>
                                                <article class="ntry noThmb">
                                                    ...
                                                    <div class="iFxd">
                                                        <a aria-label="Comments" class="cmnt" data-text="Booking Now" href="booking.php?id=<?php echo $row['id']; ?>" role="button">
                                                        </a>
                                                    </div>
                                                    <div class="pCntn">
                                                        <div class="pHdr pSml">
